...
{
    public class BugTrackerTicketHistoryService : IBugTrackerHistoryService
    {
        private readonly ApplicationDbContext _context;

        public BugTrackerTicketHistoryService(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task AddHistoryAsync(Ticket oldTicket, Ticket newTicket, string userId)
        {
            ...
            else
            {
                ...
                try
                {
                    // Save The Changes To The DataBaseSet To The Database
                    await _context.SaveChangesAsync();
                }
                catch (Exception)
                {
