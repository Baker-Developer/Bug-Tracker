...
namespace BugTracker.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ILogger<HomeController> logger,
                              IBugTrackerCompanyInfoService companyInfoService, IBugTrackerProjectService projectService)
        {
            _logger = logger;
        ...
        public async Task<JsonResult> GglProjectPriority()
        {
            ...
            foreach (string priority in Enum.GetNames(typeof(BugTrackerProjectPriority)))
            {
